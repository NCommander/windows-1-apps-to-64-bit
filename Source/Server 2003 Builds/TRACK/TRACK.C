...
LRESULT CALLBACK TrackWndProc(HWND, UINT, LPARAM, WPARAM);
...
HDC hDC;
{
    ...
    SetWindowOrgEx( hDC, -10, 110, NULL );
    SetWindowExtEx( hDC, 120, -120, NULL );
...
LRESULT WINAPI TrackWndProc( hWnd, message, wParam, lParam )
HWND hWnd;
UINT message;
WPARAM wParam;
LPARAM lParam;
{
    ...
    case WM_LBUTTONDBLCLK:
    case WM_RBUTTONDBLCLK:
		thePoint.x = GET_X_LPARAM(lParam);
		thePoint.y = GET_Y_LPARAM(lParam);
        TrackMouse( hWnd, message, thePoint );
        break;
