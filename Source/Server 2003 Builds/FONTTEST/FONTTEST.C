...
LRESULT CALLBACK FonttestWndProc(HWND, UINT, WPARAM, LPARAM);
...
WORD id;
{
    ...
    case IDMOPTIONS:
        DialogBox( hInst, MAKEINTRESOURCE(OPTIONSBOX), hWindow, (DLGPROC)lpprocOptions );
        break;
...
LRESULT CALLBACK FonttestWndProc( hWnd, message,  wParam, lParam )
HWND hWnd;
UINT  message;
WPARAM wParam;
LPARAM lParam;
...
int WINAPI WinMain(hInstance, hPrev, lpszCmdLine, cmdShow)
HINSTANCE hInstance, hPrev;
LPSTR lpszCmdLine;
int cmdShow;
{
    MSG msg;
